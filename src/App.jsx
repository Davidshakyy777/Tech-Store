  ...
  return (
    <>
      <div className='py-8 px-16'>
        ...
        <p className='mt-4'>
          Tech Store — дүкенімізде смартфондар, ноутбуктер, планшеттер, құлаққаптар және басқа да әртүрлі электронды құрылғылар сатылады. Барлық тауарлар оригинал, сапалы және ресми кепілдікпен ұсынылады.

          Дүкен кіленттерге тиімді баға, үлкен таңдау және сапалы қызмет көрсетуді ұсынады. Сондықтан техника сатып алуда қауіпсіз әрі пайдалы таңдау болып саналады.
        </p>
